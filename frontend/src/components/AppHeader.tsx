 ...
 * Hidden entirely in Presenter Mode; the toggle keeps its own escape hatch.
 */
export function AppHeader() {
  ...
  return (
    <header className="border-ink-line bg-shell-void fixed inset-x-0 top-0 z-40 h-16 border-b">
